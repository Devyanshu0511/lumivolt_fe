...
const ContactSection = () => {
  ...
  return (
    <section
      id="contact"
      className={`py-16 sm:py-20 lg:py-24 xl:py-32 relative overflow-hidden ${darkMode ? "bg-slate-950" : "bg-gradient-to-b from-gray-50 to-gray-100"
        }`}
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.h2
            ...
            className={`text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight ${darkMode ? "text-white" : "text-slate-900"
              }`}
          >
          ...
          <motion.p
            ...
            className={`max-w-3xl mx-auto mt-6 text-lg leading-relaxed ${darkMode ? "text-gray-300" : "text-gray-600"
              }`}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <p
              className={`mb-8 leading-relaxed ${darkMode ? "text-gray-300" : "text-gray-600"
                }`}
            >
              ...
              {[
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      className={`mt-1 text-sm leading-relaxed ${darkMode ? "text-gray-300" : "text-gray-600"
                        }`}
                    >
                      {item.content}
                    </p>
        ...
        >
          <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-200/30">
            <div
              className={`p-4 flex items-center justify-between ${darkMode ? "bg-slate-900/50" : "bg-white/80"
                }`}
            >
